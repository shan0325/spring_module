...
import com.sm.app.admin.web.admin.usecase.AdminUseCase;
...
public class AdminController {
    ...
    public ResponseEntity<Page<AdminsResponseDto>> getAdmins(
        ...
        return ResponseEntity.ok(adminUseCase.getAdmins(searchAdminRequestDto, pageable));
    }

    @GetMapping("/admins/{id}")
    public String getAdmin(@PathVariable Long id, Model model) {
        model.addAttribute("admin", adminUseCase.getAdmin(id));
        model.addAttribute("roles", roleUseCase.getRolesBySiteType(SiteTypeEnum.ADMIN));
    ...
    public ResponseEntity<Object> modifyAdmin(@PathVariable Long id,
        ...
        adminUseCase.modifyAdmin(id, adminModifyRequestDto);
    ...
    public ResponseEntity<Object> passwordChange(@AuthenticationPrincipal LoginInfo loginInfo,
        ...
        adminUseCase.passwordChange(loginInfo.getMemberId(), adminPasswordChangeRequestDto);
        return ResponseEntity.ok().build();
    }
}
